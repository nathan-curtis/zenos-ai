...
| Version | Change |
|---------|--------|
| (2026-08-14) | New `envelope_check` pilot diagnostic — see above. Dispatches on `tool=`, not `mode=`; tool_manifest version wasn't bumped for this addition, flagging per the known version-source normalization gap (Zammad #10300). |
