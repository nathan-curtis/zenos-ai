...
>
> **Versions:** each tool's own `tool_manifest` version is canonical — it is what `mode=help`, `audit_help`, and ToolMap report. Files carrying several scripts list a version per script; automations with no `tool_manifest` use their file header.
...
## 0. Zen DojoTools Scribe — v5.2.0
**File:** [`zen_dojotools_scribe_readme.md`](zen_dojotools_scribe_readme.md)
...
## 1. Zen DojoTools AdminTools — per-script versions (see readme)
**File:** [`zen_dojotools_admintools_readme.md`](zen_dojotools_admintools_readme.md)
...
**File:** [`zen_flynn_readme.md`](zen_flynn_readme.md)
...
## 3. Zen DojoTools Profile Editor — v5.3.0 · Persona Editor v1.2.1
**File:** [`zen_dojotools_profile_readme.md`](zen_dojotools_profile_readme.md)
...
## 4. Zen DojoTools Labels — v5.5.0
**File:** [`zen_dojotools_labels_readme.md`](zen_dojotools_labels_readme.md)
...
**File:** [`zen_pipeline_trigger_pattern.md`](zen_pipeline_trigger_pattern.md)
...
**File:** [`zen_home_mode_readme.md`](zen_home_mode_readme.md)
...
## 10. Zen DojoTools History — v5.1.1
**File:** [`zen_dojotools_history_readme.md`](zen_dojotools_history_readme.md)
...
## 11. Zen DojoTools Utilities — per-script versions (see readme)
**File:** [`zen_dojotools_utilities_readme.md`](zen_dojotools_utilities_readme.md)
...
## 12. Zen DojoTools Core (FileCabinet GC) — v4.5.1
**File:** [`zen_dojotools_core_readme.md`](zen_dojotools_core_readme.md)
...
## 13. Zen DojoTools SystemTools — v5.2.0
**File:** [`zen_dojotools_systemtools_readme.md`](zen_dojotools_systemtools_readme.md)
...
## 15. Zen DojoTools Event Emitter — v1.0.0
**File:** [`zen_dojotools_event_emitter_readme.md`](zen_dojotools_event_emitter_readme.md)
...
## 18. Zen DojoTools Index — v5.1.0
**File:** [`zen_dojotools_index_readme.md`](zen_dojotools_index_readme.md)
...
## 19. Zen DojoTools Inspect — v5.1.0
**File:** [`zen_dojotools_inspect_readme.md`](zen_dojotools_inspect_readme.md)
...
## 20. Zen DojoTools Ectoplasm — v6.2.0
**File:** [`zen_dojotools_ectoplasm_readme.md`](zen_dojotools_ectoplasm_readme.md)
...
## 22b. Zen DojoTool Dispatcher — v5.4.3
**File:** [`zen_dojotools_dispatcher_readme.md`](zen_dojotools_dispatcher_readme.md)
...
## 23. Zen DojoTools Locks — v1.6.1
**File:** [`zen_dojotools_locks_readme.md`](zen_dojotools_locks_readme.md)
...
## 25. Zen AdminTools CertAdmin — v1.2.0
**File:** [`zen_admintools_certadmin_readme.md`](zen_admintools_certadmin_readme.md)

Admin-only cert issuance/revocation authority for AI persona (`ai_user`) cabinets. Not agent-reachable (`mcp_exposed: false`) — every call is a household-admin action, not something an agent invokes on itself.
...
## 27. Zen DojoTools Calendar — v1.1.0
...
## 29. Zen DojoTools Provisioner — v1.1.0
...
## 30. Zen DojoTools Query (ZQ-1) — v5.1.0
**File:** [`zen_dojotools_query_readme.md`](zen_dojotools_query_readme.md)

Deterministic entity selector for Home Assistant — the compiled-filter query engine underneath Index/Inspect's targeting.
