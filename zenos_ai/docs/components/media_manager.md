...
* **`channel`** — source string, passed to the room's `zen_mm_universal` `select_source`. What that entity has to do with it is the [Universal Media Player spec](zen_mm_universal_spec.md).
